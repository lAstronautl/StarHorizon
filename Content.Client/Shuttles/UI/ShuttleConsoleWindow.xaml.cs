    ...
    IComputerWindow<ShuttleBoundUserInterfaceState>
{
    ...
    public ShuttleConsoleWindow()
    {
        ...
        // Lua: placing a target mark on the MAP tab writes it to the NAV tab's radar mark
        MapContainer.RequestTargetMark += coords =>
        {
            NavContainer.SetTargetMark(coords.Position);
            NavModeButton.Pressed = true;
