...
public sealed class McpManager : IPostInjectInit
{
    ...
    private static JsonNode HandleInitialize(JsonObject @params)
    {
        ...
        return new JsonObject
        {
            ...
            {
                ["name"] = "starhorizon-mapper-mcp",
                ["version"] = "1.0.0",
            },
            ["instructions"] =
                "Embedded mapping server for Space Station 14 (StarHorizon). " +
                ...
                "and written with set_component_field. " +
                ...
                "placed with pick_variant=false, then save_map " +
