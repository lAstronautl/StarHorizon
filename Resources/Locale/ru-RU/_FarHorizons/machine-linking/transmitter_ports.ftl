...
signal-port-description-nuclear-reactor-data-sender = Передаёт данные о ядерном реакторе на монитор.
...
signal-port-description-gas-turbine-data-sender = Передаёт данные о газовой турбине на монитор.
