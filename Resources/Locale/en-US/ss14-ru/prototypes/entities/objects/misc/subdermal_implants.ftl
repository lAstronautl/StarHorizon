...
ent-ChemImplant = chem implant
    .desc = This implant injects a chemical payload into the user's bloodstream, either manually or automatically upon entering critical condition. Single use.
